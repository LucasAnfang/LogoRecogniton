...
// router.post('/:datasetId', checkAuth, upload.single('trainingImage'), DatasetController.upload_dataset);
router.post('/:datasetId', upload.array('trainingImages'), DatasetController.upload_images);
